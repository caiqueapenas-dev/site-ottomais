        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Cuidando da sua saúde com excelência, humanização e tecnologia moderna. 
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/5575999999999" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#equipe" className="text-gray-400 hover:text-white transition-colors">
                  Nossa Equipe
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">(75) 9999-9999</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="text-blue-400 flex-shrink-0" size={16} />
                <span className="text-gray-400 text-sm">contato@clinicaottomais.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-500">
              CRM-BA 12345 • CRP-BA 06/7890 • Responsável Técnico: Dr. Carlos Eduardo Silva
            </p>
          </div>
        </div>
      </div>
