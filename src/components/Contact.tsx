...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/5575999999999?text=${whatsappMessage}`, '_blank');
  };

  return (
    <section id="contato" className="py-20 bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-gray-900">Entre em</span>
            <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent"> Contato</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contato@clinicaottomais.com.br</p>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Convênios Aceitos</h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700 font-medium">Unimed</span>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700 font-medium">Bradesco Saúde</span>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700 font-medium">SulAmérica</span>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700 font-medium">Amil</span>
                </div>
              </div>
          ...
          {/* Contact Form */}
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Solicite um Retorno</h3>
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              Ao enviar este formulário, você será redirecionado para nosso WhatsApp 
        ...
        <div className="mt-16">
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <p className="text-sm text-gray-600 mt-4">
              Localização central de fácil acesso, com estacionamento próximo e transporte público.
            </p>
          </div>
        </div>
      </div>
