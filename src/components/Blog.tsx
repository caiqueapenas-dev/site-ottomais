  ...
  const posts: BlogPost[] = [
    {
      ...
      excerpt: "Descubra os sintomas que indicam a necessidade de consultar um especialista em ouvido, nariz e garganta.",
      category: "Otorrinolaringologia",
      readTime: "5 min",
      date: "15 Dez 2024",
      image: "https://images.pexels.com/photos/5452268/pexels-photo-5452268.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop"
    },
    {
      title: "Cuidando da Saúde Mental: A Importância da Psicoterapia",
      excerpt: "Entenda como a psicoterapia pode transformar sua qualidade de vida e bem-estar emocional.",
      category: "Psicologia",
      readTime: "7 min",
      date: "12 Dez 2024",
    ...
    },
    {
      ...
      excerpt: "Aprenda como proteger sua audição no dia a dia e prevenir problemas auditivos comuns.",
      category: "Otorrinolaringologia",
      readTime: "4 min",
      date: "10 Dez 2024",
      image: "https://images.pexels.com/photos/3845457/pexels-photo-3845457.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent"> Saúde</span>
          </h2>
